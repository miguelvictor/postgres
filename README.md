...
It's possible to create multiple updates in a single query. It's necessary to use arrays intead of objects to ensure the order of the items so that these correspond with the column names.
```js
const users = [
  [1, 'John', 34],
  [2, 'Jane', 27],
